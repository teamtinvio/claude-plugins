...
### Online Payments
Source: https://help.jaz.ai/en/articles/12274624-online-payments
...
**Q2. How do I enable online payments in invoices?**
...
**Q3. How do I create a payment profile?**
...
- **Note:** Each payment method can only be linked to one gateway, but you may duplicate methods if needed.**Q4. Can I create multiple payment profiles?**

- Yes. You can create multiple profiles for different business needs.

**Q5. Is it possible to track gateway fees from online payments?**

- Yes. Enable recording of processing fees in your payment profile under **Fees Setting**, select the Chart of Account, and add a description.**Q6. Can I pass processing fees to my customers?**
...
**Q7. Why can’t I enable online payments?**

- Check that you are using a business account, not a personal account, of your payment gateway since APIs are only available for business accounts. Also ensure your **[Payment Profile](#h_ca44dee003)**is set up and active.

**Q8. Where can I use online payments?**

- You can use online payments in invoices, subscription schedulers, and invoice schedulers.

**Q9. My online payment option is not appearing in my invoice, what should I do?**

- Online payments are off by default. To activate, open the invoice and click **Enable Online Payments** in the sidebar.
- **Note:** When using online payments, preview the invoice first to confirm the correct payment option is enabled. Changes to online payment settings apply retroactively.**Q10. Do payments go directly to my business account?**

- Yes. Payments made through invoices go directly to your connected business account.

**Q11. Can customers make partial payments?**
