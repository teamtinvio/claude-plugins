...
**Q1. What is pretty case formatting in Jaz?**

- You can easily format all your item names/descriptions by selecting the text case you would like to use.

**Q2. Why don't I see the pretty case formatting icon on my transaction?**

- The pretty case formatting icon appears only when:
  - You have entered at least one item name or description.
  - If a customer/supplier is selected and the autofill icon appears, the pretty case icon will only show after you click the autofill icon or manually enter item details.
- Note: Pretty case formatting applies only to manually entered items. Items selected from the item list are not eligible for case formatting.
...
**Q1. What is Magic Search?**

- Magic Search is a natural language search engine that lets you find your invoices and bills using everyday language.
- For example, you can search "find all invoices with attachments" or "find all overdue bills for contact John Doe."

**Q2. How do I switch to magic search from normal search in Jaz?**

- The search icon dictates whether magic or normal search is turned on.
- Click the search icon to enable or disable Magic Search.

**Q3. Why can't I access the magic search feature?**

- Magic search is not available for all the plans. Check out all the plans & features included here - [Jaz Plans](https://help.jaz.ai/en/articles/9117234-plans)
...
### Choosing Plans & Addons
Source: https://help.jaz.ai/en/articles/11710415-choosing-plans-addons
...
- A billing account is used to manage payments for Jaz **[Plans & Add-ons](https://help.jaz.ai/en/articles/11710415-choosing-plans-addons)**. It allows you to add funds or set up payment methods to cover charges efficiently.**Q3. How do I create billing accounts?**
...
**Q4. How do I recharge my billing accounts?**

- To recharge your account, you can manually top up or turn on the **auto charge function**.**Q5. How do saved payment methods work?**
...
**Q6. How do I set up auto-charge and add payment methods?**
...
**Q7. I’ve set up my Billing Account, what’s next?**
