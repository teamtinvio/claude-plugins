...
**Q21. Can I add dynamic information to scheduled invoices so each one is different?**

- Yes, you can add dynamic information to scheduled invoices using scheduler strings. These strings generate dynamic data based on the transaction date, with values automatically updated relative to the date.
- You can find the available scheduler strings in the information tooltip while creating a new scheduled invoice.
